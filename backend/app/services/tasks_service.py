...
What This File Does:
- create_task: Save a new task
- get_tasks: Get all tasks for a user
- get_task: Get one task by ID
- update_task: Update an existing task
- delete_task: Delete a task

Why We Need This:
- Business logic is separate from routes
...
def get_tasks(db: Session, user_id: int, status: str = None) -> list:
